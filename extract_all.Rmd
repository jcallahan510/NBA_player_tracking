...
# dir_list <- c('/data/p_dsi/nba_player_movement/data_feather_file/group1',
#               '/data/p_dsi/nba_player_movement/data_feather_file/group2',
#               '/data/p_dsi/nba_player_movement/data_feather_file/group3',
#               '/data/p_dsi/nba_player_movement/data_feather_file/group4',
#               '/data/p_dsi/nba_player_movement/data_feather_file/group5',
#               '/data/p_dsi/nba_player_movement/data_feather_file/group6',
#               '/data/p_dsi/nba_player_movement/data_feather_file/group7',
#               '/data/p_dsi/nba_player_movement/data_feather_file/group8',
#               '/data/p_dsi/nba_player_movement/data_feather_file/group9')
...
for(i in curr_dir){
  ...
  files_batch_1 <- append(files_batch_1, files)
}

files_batch_1 <- files_batch_1[!is.na(files_batch_1)]
...
```{r}
shot_attempts_batch_1 <- NULL




for(i in files_batch_1){
  ...
  shot_attempts_batch_1 <- bind_rows(shot_attempts_final, shot_attempts_batch_1)
