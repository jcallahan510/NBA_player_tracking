...
```{r}
movement <- read_csv("data/0021500520.csv")
...
p_id_list <- rep(c(-1, 'p1', 'p2', 'p3', 'p4', 'p5', 'p6', 'p7', 'p8', 'p9', 'p10'), nrow(shot_rows))
...
shot_attempts_all <- bind_rows(shot_attempts_final, shot_attempts_all)
