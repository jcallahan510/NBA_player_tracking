...
#files_batch_1 <- files_batch_1[-20]
...
write.csv(shot_attempts_batch_1, 'shot_attempts_batch_1.csv', row.names = FALSE)
```


```{r}
shots_join %>% 
  filter(game_id == "0021500001")
...
```{r}
movement %>% 
  filter(game_clock == 96.14, quarter == 3)
```
