...
shots_010216 <- shots_join %>% 
  ...
  select(game_event_id, q = quarter, mins = minutes_remaining, secs = seconds_remaining, player = player_name, dist = shot_distance, q_event_clock, everything()) %>% 
...
shot_times_010216 <- shots_010216 %>% 
  mutate(upward_to_hoop_time = case_when(game_event_id == 15 ~ 1.56,
                                         game_event_id == 23 ~ 1.63,
                                         game_event_id == 46 ~ .4,
                                         game_event_id == 55 ~ 1.76,
                                         game_event_id == 208 ~ 1.7,
                                         game_event_id == 237 ~ 1.55,
                                         game_event_id == 324 ~ .5,
                                         game_event_id == 396 ~ 1.57, 
                                         game_event_id == 462 ~ 1.2,
                                         #game_event_id == 468 ~ 1.1,
                                         game_event_id == 496 ~ .65,
                                         game_event_id == 499 ~ 1.4,
                                         game_event_id == 501 ~ 1.08,
                                         game_event_id == 535 ~ 1.3,
                                         game_event_id == 537 ~ .7,
                                         #game_event_id == 552 ~ 1.1
                                         )) %>% 
...
shot_times_010416 <- shots_010416 %>% 
  mutate(upward_to_hoop_time = case_when(game_event_id == 127 ~ 1.38,
                                         game_event_id == 132 ~ 1.4,
                                         game_event_id == 260 ~ .55,
                                         game_event_id == 310 ~ 1.5,
                                         game_event_id == 393 ~ 1.70
                                         )) %>% 
  filter(!is.na(upward_to_hoop_time))
...
shot_times_010516 <- shots_010516 %>% 
  mutate(upward_to_hoop_time = case_when(game_event_id == 81 ~ 1.57,
                                         game_event_id == 102 ~ 1.57,
                                         game_event_id == 121 ~ .75,
                                         game_event_id == 321 ~ 1.16,
                                         game_event_id == 348 ~ 1.49
                                         )) %>% 
  filter(!is.na(upward_to_hoop_time))
...
shot_times_010816 <- shots_010816 %>% 
  mutate(upward_to_hoop_time = case_when(game_event_id == 63 ~ .9,
                                         game_event_id == 78 ~ 1.65,
                                         game_event_id == 102 ~ 1.64,
                                         game_event_id == 112 ~ 1.7,
                                         game_event_id == 193 ~ 1.58,
                                         game_event_id == 210 ~ .27,
                                         game_event_id == 284 ~ 1.58,
                                         game_event_id == 325 ~ 1.51,
                                         game_event_id == 340 ~ .32,
                                         game_event_id == 393 ~ 1.56,
                                         )) %>% 
  filter(!is.na(upward_to_hoop_time))
...
shot_times_010916 <- shots_010916 %>% 
  mutate(upward_to_hoop_time = case_when(game_event_id == 96 ~ .83,
                                         game_event_id == 196 ~ .94,
                                         game_event_id == 102 ~ 1.64,
                                         game_event_id == 259 ~ 1.59,
                                         game_event_id == 316 ~ .41,
                                         game_event_id == 458 ~ 1.59,
                                         game_event_id == 474 ~ 1.10,
                                         game_event_id == 492 ~ 1.67
                                         )) %>% 
  filter(!is.na(upward_to_hoop_time))
...
shot_times_011116 <- shots_011116 %>% 
  mutate(upward_to_hoop_time = case_when(#game_event_id == 66 ~ 1.21,
                                         game_event_id == 92 ~ 1.43,
                                         game_event_id == 119 ~ 1.25,
                                         game_event_id == 189 ~ .56,
                                         game_event_id == 202 ~ .74,
                                         game_event_id == 248 ~ .71,
                                         game_event_id == 301 ~ .92,
                                         game_event_id == 336 ~ 1.60,
                                         game_event_id == 417 ~ 1.31,
                                         game_event_id == 463 ~ 1.65,
                                         game_event_id == 479 ~ 1.60,
                                         game_event_id == 506 ~ 1.59,
                                         )) %>% 
  filter(!is.na(upward_to_hoop_time))
...
```{r}
p_id_list <- rep(c(-1, 'p1', 'p2', 'p3', 'p4', 'p5', 'p6', 'p7', 'p8', 'p9', 'p10'), 168)
